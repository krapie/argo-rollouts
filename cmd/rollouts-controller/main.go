...
func newCommand() *cobra.Command {
	var (
		...
		awsTargetGroupBindingVersion   string
		istioVersion                   string
	...
	var command = cobra.Command{
		...
		RunE: func(c *cobra.Command, args []string) error {
			...
			defaults.SetTargetGroupBindingAPIVersion(awsTargetGroupBindingVersion)
	...
	command.Flags().StringVar(&awsTargetGroupBindingVersion, "aws-target-group-binding-api-version", defaults.DefaultTargetGroupBindingAPIVersion, "Set the default AWS TargetGroupBinding apiVersion that controller uses when verifying target group weights.")
